...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ATR");
    case mBTC: return QString("mATR");
    case uBTC: return QString::fromUtf8("μATR");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("AtroxCoins"));
    case mBTC: return QString(QObject::tr("Milli-AtroxCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-AtroxCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
